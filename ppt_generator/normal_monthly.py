"""
Normal Monthly Report — single month snapshot.
...
def build(period: dict, insights: list = None) -> bytes:
    ...
    # ── SLIDE 1: COVER ────────────────────────────────────────────────────────
    CM.add_cover(prs, "Monthly Wellness Data Report", label)
    ...
    # ── SLIDE 7: GENDER DISTRIBUTION (SINGLE PIE) ─────────────────────────────
    s7 = CM.add_slide(prs)
    CM.add_logo(s7)
    CM.add_section_header(s7, f"GENDER DISTRIBUTION  |  {label}", Inches(0.15), Inches(0.75),
                          Inches(13.0), Inches(0.45), bg_color=C.PRIMARY)
    ...
    # ── SLIDE 8: MODE OF SESSION (SINGLE PIE) ─────────────────────────────────
    s8 = CM.add_slide(prs)
    CM.add_logo(s8)
    CM.add_section_header(s8, f"MODE OF SESSION  |  {label}", Inches(0.15), Inches(0.75),
                          Inches(13.0), Inches(0.45), bg_color=C.PRIMARY)
    ...
    # ── SLIDES 9-11: TEMPLATE (GENDER / CONCERN / STAKEHOLDER, vertical-wise) ─
